...
def apply():
    ...
    if current_user.is_vendor or get_active_application_for_user(current_user.id) is not None:
        flash("You are already a vendor!", "danger")
    ...
    if form.validate_on_submit():
        ...
        flash("Vendor application successfully submitted!", "success")
        return redirect(url_for("dashboard.index"))
...
def application(id):
    ...
    if application is None or not application.is_active:
        flash("Application does not exist or is already completed!", "danger")
        return redirect(url_for("dashboard.index"))
...
def approve_application(id):
    ...
    flash("Application successfully approved!", "success")
    return redirect(url_for("vendor.applications"))
...
def deny_application(id):
    ...
    flash("Application successfully denied!", "success")
    return redirect(url_for("vendor.applications"))
...
def revoke_vendor(id):
    ...
    flash("Vendor status successfully revoked!", "success")
    return redirect(url_for("vendor.manage"))